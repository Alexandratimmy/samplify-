...
export const SamplifyLogo: React.FC<IconProps> = ({ className }) => (
    <div className={`flex items-center gap-2 ${className}`}>
        <div className="w-9 h-9 bg-gradient-to-br from-[#c142c4] to-pink-500 rounded-xl flex items-center justify-center shadow-lg shadow-[#c142c4]/30">
            <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M13 7l5 5m0 0l-5 5m5-5H6" />
            </svg>
        </div>
        <span className="text-2xl font-bold text-white tracking-tighter hidden sm:inline">Samplify</span>
    </div>
);
...
export const MessageIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 4v6a2 2 0 002 2h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 001.414 0l3.414-3.414a1 1 0 01.707-.293H18a2 2 0 002-2z" />
    </svg>
);
...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L11 15l-4 6h10l-4-6 2.293-2.293a1 1 0 011.414 0L19 10m-5 8v-2m0-2v-2" />
    </svg>
);
...
export const LikeIconFilled: React.FC<IconProps> = ({ className }) => (
...
export const ShareIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"></path><polyline points="16 6 12 2 8 6"></polyline><line x1="12" y1="2" x2="12" y2="15"></line></svg>
);
